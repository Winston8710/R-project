...
###1.經營現況：期中報告精華(地區、年齡、顧客分群的消費特性)(期中1+2)+上字幕-秉
###2.改善策略：根據顧客族群價值屬性(地理、年齡、產品),選取行銷重點、設定行銷目標(期中3+4)-寧
###3.製作模型：找出影響回購機率和金額的主要變數、預測顧客未來價值→作為行銷方案設計參考-萱
###4.行銷方案：根據各族群特徵設計行銷工具與方案-荃
###5.預期成效：對方案的成本、效益進行假設+統整PPT-郁

####時程

###1. PPT各自部分繳交：6/12 晚上12點前
###2. 討論+錄音完成：6/13 下午1:00
###3. 字幕完成：6/14前
